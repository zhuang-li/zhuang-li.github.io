...
- **EMNLP 2025 Outstanding Paper Award**, senior author, for *DiscoSG: Towards Discourse-Level Text Scene Graph Parsing through Iterative Graph Refinement*; one of seven such awards among 3,200+ accepted papers.
...
My supervision is centred on **Trustworthy LLMs**, **Domain-grounded AI**, and **Structured NLP**. See the [Supervision](/supervision/) page for current supervision areas and students.
...
- **[FactualSceneGraph](https://github.com/zhuang-li/FactualSceneGraph)**: toolkit for faithful and consistent textual scene-graph parsing, connecting [FACTUAL](https://aclanthology.org/2023.findings-acl.398/) (Findings of ACL 2023) with [DiscoSG](https://aclanthology.org/2025.emnlp-main.398/) (EMNLP 2025 Outstanding Paper Award); 240,000+ PyPI downloads and 600,000+ model downloads on Hugging Face.
